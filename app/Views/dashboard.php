...
<head>
    ...
    <link rel="manifest" href="<?= base_url() ?>/public/manifest2.json">
    <!-- endinject -->
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?= base_url() ?>/public/images/king.png" />
    <script>
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start pl-3">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="https://instagram.com/kingcoffee_sandai?igshid=MzRlODBiNWFlZA==">
                        <h2>King Coffe</h2>
                    </a>
